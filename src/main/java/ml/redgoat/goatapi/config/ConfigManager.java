package ml.redgoat.goatapi.config;
...
public class ConfigManager {
    ...
    public static void saveConfig(JavaPlugin plugin, Object configObject) {
        ...
        if (configAnnotation == null) {
            plugin.getLogger().severe("The provided Configuration Java class was not annotated properly with @Config from GoatAPI. Therefore the config could not be saved.");
            plugin.getPluginLoader().disablePlugin(plugin);
        } else {
